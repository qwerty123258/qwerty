...
<body>
   <div class="pac-card" id="pac-card">
      ...
      <div id="pac-container">
         ...
         <button id="addressSet" onclick="addresscheck()">완료</button>
      </div>
   </div>
   <div id="map"></div>
   ...
   var lng;
      ...
      function addresscheck() {
         ...
         opener.document.getElementById("longitude").value=lng;

         var nonBlankStr = document.getElementById("pac-input").value.split(' '); 
         opener.document.getElementById("nation").value=nonBlankStr[0];
         opener.document.getElementById("region").value=nonBlankStr[1];
         if(nonBlankStr[1]=="경기도" || nonBlankStr[1]=="강원도" || nonBlankStr[1]=="서울특별시" || nonBlankStr[1]=="경상남도" || nonBlankStr[1]=="경상북도" || nonBlankStr[1]=="충청북도" || nonBlankStr[1]=="충청남도" || nonBlankStr[1]=="전라북도" || nonBlankStr[1]=="전라남도" || nonBlankStr[1]=="제주" || nonBlankStr[1]=="제주특별자치도" || nonBlankStr[1]=="광주광역시" || nonBlankStr[1]=="부산광역시" || nonBlankStr[1]=="대전광역시" || nonBlankStr[1]=="울산광역시" || nonBlankStr[1]=="대구광역시" || nonBlankStr[1]=="인천광역시" || nonBlankStr[1]=="세종특별자치시" || nonBlankStr[1]=="세종"){
             opener.document.getElementById("region").value=nonBlankStr[1]+" "+nonBlankStr[2];
         }
         opener.document.getElementById("address").value = document.getElementById("pac-input").value;
			window.close()
      }
   </script>
   <script
